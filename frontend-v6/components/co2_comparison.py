...
def Text(totalco2):
    treeco2day=0.06 # CO2 absorbability : 0.06kg of co2e / day by a mature tree
    tree_co2day = round(totalco2/treeco2day,2)
    carco2day = 0.525 # CO2 emissions : 0.525kg of co2e / hour by a typical passenger vehicle
                  ...
                  children=[dbc.Col([
                    html.Center(children=[
                         ...
                         html.Div([html.P(treeresult),
                                  html.P("( CO2 absorbability : 0.06kg of co2e / day by a mature tree )")],style={"width":"90%"}),
                        ])
                    ...
                    html.Center(children=[
                         ...
                         html.Div([html.P(carresult),
                                  html.P("( CO2 emissions : 0.525kg of co2e / hour by a typical passenger vehicle )")],style={"width":"90%"}),
                        ])
                        ,],style={"text-align":"center"},align="center",width=3)   
                ],justify="center",)
